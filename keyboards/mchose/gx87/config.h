...
/* INDICATOR */
#define INDICATOR_HUE_STEP 6
#define INDICATOR_BRIGHTNESS_LEVELS 5 
#define INDICATOR_SPEED_STEP 6
#define INDICATOR_LED_COUNT 4
#define INDICATOR_LED_START 88
#define BREATHING_SPEEDUP_FACTOR 16
...
#define INDICATOR_EECONFIG_DATA_SIZE 4 //bytes
#define WB_EECONFIG_DATA_SIZE 1 //bytes
#define EECONFIG_KB_DATA_SIZE (INDICATOR_EECONFIG_DATA_SIZE + WB_EECONFIG_DATA_SIZE)
